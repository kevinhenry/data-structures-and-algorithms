...
const typeNum = (arr) => {
  // Solution code here...
  let numOnly = arr.filter(num => typeof num === 'number');
  return numOnly;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let andOnly = arr.filter(and => and.includes('and'));
  return andOnly;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddOnly = arr.filter(num => num%2);
  return oddOnly;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let oddBall = arr.filter(num => !forbiddenValues.includes(num));
  return oddBall;
};
